...
capture_manager = pygame.camera.Camera(camlist[0],(320,240),"RGB")
...
def main(args):
    ...
    while 1:
        ...
        surfaceObject = capture_manager.get_image()
        screen.blit(surfaceObject, (0, 0))

        # Convert pygame camera surface object into 3D array  
        surface_to_array = pygame.surfarray.pixels3d(surfaceObject);

        # Reshape 3D Array into an image frame of dimension [224,224,]
        frame = surface_to_array[0:224,0:224, :]
